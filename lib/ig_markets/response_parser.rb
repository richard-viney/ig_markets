module IGMarkets
  ...
  module ResponseParser
    ...
    #                                       `Hash` then all hash keys will converted from camel case into snake case and
    #                                       their values each to parsed individually by a recursive call. If this is of
    #                                       type `Array` then each item will be parsed indidiaully by a recursive call.
