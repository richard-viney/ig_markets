...
PositionUpdate - account_id: ACCOUNT, channel: web, deal_id: DEAL, deal_id_origin: DEAL2, deal_reference: reference, deal_status: accepted, direction: buy, epic: CS.D.EURUSD.CFD.IP, level: 1.1, limit_level: 1.2, size: 5.0, status: open, stop_level: 1.0, timestamp: 2015-12-15 15:00:00 +0000
WorkingOrderUpdate - account_id: ACCOUNT, channel: Web, deal_id: DEAL, deal_reference: reference, deal_status: accepted, direction: buy, epic: CS.D.EURUSD.CFD.IP, level: 1.09, limit_distance: 50, size: 5.0, status: open, stop_distance: 50, timestamp: 2015-12-15 15:00:00 +0000
