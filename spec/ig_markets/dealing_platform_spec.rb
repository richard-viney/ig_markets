describe IGMarkets::DealingPlatform, :dealing_platform do
  ...
  it 'raises an error when trying to instantiate a model from an unsupported type' do
    expect { dealing_platform.instantiate_models IGMarkets::Model, 10 }
      .to raise_error(ArgumentError, "IGMarkets::Model: can't instantiate from a source of type #{10.class}")
  end
