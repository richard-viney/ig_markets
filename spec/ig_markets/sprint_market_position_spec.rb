describe IGMarkets::SprintMarketPosition do
  ...
  it 'correctly calculates seconds till expiry' do
    sprint_market_position = build(
      :sprint_market_position, expiry_time: Time.new(2015, 1, 1, 0, 0, 5, 0), dealing_platform: platform)
  ...
  it 'correctly calculates seconds till expiry' do
    sprint_market_position = build(
      :sprint_market_position, expiry_time: Time.new(1, 1, 1, 0, 0, 0, 0), dealing_platform: platform)
