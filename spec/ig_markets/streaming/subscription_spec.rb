describe IGMarkets::Streaming::Subscription, :dealing_platform do
  ...
  it 'processes account data' do
    ...
    subscription.send :on_raw_data, nil, 'ACCOUNT:ABC1234', item_data, item_data
  end
  ...
  it 'processes market data' do
    ...
    subscription.send :on_raw_data, nil, 'MARKET:ABC1234', item_data, item_data
  end
  ...
  it 'processes a deal confirmation' do
    ...
    subscription.send :on_raw_data, nil, 'TRADE:ABC1234', nil, confirms: item_data.to_json
  end
  ...
  it 'processes a position update' do
    ...
    subscription.send :on_raw_data, nil, 'TRADE:ABC1234', nil, opu: item_data.to_json
  end
  ...
  it 'processes a working order update' do
    ...
    subscription.send :on_raw_data, nil, 'TRADE:ABC1234', nil, wou: item_data.to_json
  end
  ...
  it 'processes a chart tick update' do
    ...
    subscription.send :on_raw_data, nil, 'CHART:ABC1234:TICK', nil, item_data
  end
  ...
  it 'processes a consolidated chart data update' do
    ...
    subscription.send :on_raw_data, nil, 'CHART:ABC1234:HOUR', item_data, item_data
  end
end
